...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <c:forEach var="pontuacao" items="${pontuacoes}" varStatus="counter">
        ...
        <div class="${style}" role="alert">
          ${counter.index + 1} &ordm;&nbsp;&nbsp; ${pontuacao.jogador.nome} <strong class="pull-right">${pontuacao.totalPontos} pontos</strong>
        </div>
      </c:forEach>
      </div>
